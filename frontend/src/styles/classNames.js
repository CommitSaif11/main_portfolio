...
export const cardBase =
  `h-full flex flex-col bg-bg-surface border border-border-subtle rounded-md p-6 transition duration-base ease ` +
  `hover:bg-bg-surface-hover hover:border-teal-500/40 hover:shadow-glow-teal hover:scale-[1.02]`
...
export const tagTeal = 'text-xs border border-teal-500/40 text-teal-400 rounded-sm px-2 py-1'
